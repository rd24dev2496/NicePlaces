package com.example.projectmvvmlocation.repositories;
...
public class NicePlaceRepository {
    ...
    private final ArrayList<NicePlace> dataSet = new ArrayList<>();
    ...
    private void setNicePlaces(){
        dataSet.add(
                new NicePlace("https://i.redd.it/tpsnoz5bzo501.jpg","Havasu Falls")
        );
        dataSet.add(
